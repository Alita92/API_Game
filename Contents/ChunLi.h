...
class ChunLi : public CharacterHandle
{
private:	// member Var
	friend Projectile;
	...
	float chargingTimeBack_; 
	float chargingTimeDown_;

public:		
	ChunLi(); // default constructer 디폴트 생성자
	~ChunLi() override; // default destructer 디폴트 소멸자

public:		// delete constructer
	ChunLi(const ChunLi& _other) = delete; // default Copy constructer 디폴트 복사생성자
	ChunLi(ChunLi&& _other) noexcept; // default RValue Copy constructer 디폴트 RValue 복사생성자

public:		//delete operator
	ChunLi& operator=(const ChunLi& _other) = delete; // default Copy operator 디폴트 대입 연산자
	ChunLi& operator=(const ChunLi&& _other) = delete; // default RValue Copy operator 디폴트 RValue 대입연산자
...
public:
	void ChangeState(ChunLiState _stateType);
